...
public class App {
    ...
    private static School createSchoolObject() {
        ...
        s.setter(1, "Alberto", new Date(), 20, new Date(), "addr");
        Professor p = new Professor();
        p.setter(1, "Albertina", "3243242", "42342423", "addr");
    ...
    private static ProfessorBuffer professorBuffer(){
        ProfessorBuffer p =  new ProfessorBuffer();
